...
test( 'Search Bounds Top.', function( t ){
	...
	viewport.y = -100;
	t.equals( searchBounds.searchY( objects, viewport, proxy ), -1 );

	viewport.y = 0;
	t.equals( searchBounds.searchY( objects, viewport, proxy ), 0 );
	...
	viewport.y = 200;
	t.equals( searchBounds.searchY( objects, viewport, proxy ), 2 );

	viewport.y = 300;
	t.equals( searchBounds.searchY( objects, viewport, proxy ), 3 );

	viewport.y = 400;
	t.equals( searchBounds.searchY( objects, viewport, proxy ), 4 );

	viewport.y = 900;
	t.equals( searchBounds.searchY( objects, viewport, proxy ), 9 );
