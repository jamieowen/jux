...
test( 'Search Bounds Left.', function( t ){
	...
	viewport.x = -100;
	t.equals( searchBounds.searchX( objects, viewport, proxy ), -1 );

	viewport.x = 0;
	t.equals( searchBounds.searchX( objects, viewport, proxy ), 0 );
	...
	viewport.x = 200;
	t.equals( searchBounds.searchX( objects, viewport, proxy ), 2 );

	viewport.x = 300;
	t.equals( searchBounds.searchX( objects, viewport, proxy ), 3 );

	viewport.x = 400;
	t.equals( searchBounds.searchX( objects, viewport, proxy ), 4 );

	viewport.x = 900;
	t.equals( searchBounds.searchX( objects, viewport, proxy ), 9 );
